        ...
        var e = function () {
            if (0 != $("#m_chart_personal_income_quater_1").length) {
                var e = new Chartist.Pie("#m_chart_personal_income_quater_1", {
                    ...
                    }, {value: 32, className: "custom", meta: {color: mApp.getColor("warning")}}, {
                        value: 36,
                        className: "custom",
                        ...
                        if (0 != $("#m_chart_personal_income_quater_2").length) {
                            var e = new Chartist.Pie("#m_chart_personal_income_quater_2", {
                                series: [{
                                    value: 22,
                                    className: "custom",
                                    meta: {color: mApp.getColor("focus")}
                                }, {value: 44, className: "custom", meta: {color: mApp.getColor("success")}}, {
                                    value: 34,
                                    className: "custom",
                        ...
                        if (0 != $("#m_chart_personal_income_quater_3").length) {
                            var e = new Chartist.Pie("#m_chart_personal_income_quater_3", {
                                series: [{
                                    value: 47,
                                    className: "custom",
                                    meta: {color: mApp.getColor("info")}
                                }, {value: 55, className: "custom", meta: {color: mApp.getColor("danger")}}, {
                                    value: 27,
                                    className: "custom",
                                    meta: {color: mApp.getColor("brand")}
                                }], labels: [1, 2, 3]
                    ...
                    !function () {
                        if (0 != $("#m_chart_personal_income_quater_4").length) {
                            var e = new Chartist.Pie("#m_chart_personal_income_quater_4", {
                                ...
                                }, {value: 65, className: "custom", meta: {color: mApp.getColor("primary")}}, {
                                    value: 33,
                                    className: "custom",
                                    meta: {color: mApp.getColor("danger")}
                                }], labels: [1, 2, 3]
        ...
        init: function () {
            ...
            !function () {
                ...
                series: [{
                    ...
                    className: "custom",
                    meta: {color: mApp.getColor("brand")}
                }, {value: 32, className: "custom", meta: {color: mApp.getColor("accent")}}, {
                    value: 36,
                    className: "custom",
                    meta: {color: mApp.getColor("warning")}
                }], labels: [1, 2, 3]
                ...
                if (0 != $("#m_chart_latest_updates").length) {
                    var e = document.getElementById("m_chart_latest_updates").getContext("2d"), t = {
                        type: "line",
                        data: {
                            labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                            datasets: [{
                ...
                if (0 != $("#m_chart_trends_stats").length) {
                    var e = document.getElementById("m_chart_trends_stats").getContext("2d"), t = e.createLinearGradient(0, 0, 0, 240);
                ...
                if (0 != $("#m_chart_trends_stats_2").length) {
                    var e = document.getElementById("m_chart_trends_stats_2").getContext("2d"), t = {
                        type: "line",
                        data: {
                            labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "January", "February", "March", "April"],
                            datasets: [{
                ...
                if (0 != $("#m_chart_latest_trends_map").length)try {
                    new GMaps({div: "#m_chart_latest_trends_map", lat: -12.043333, lng: -77.028333})
                } catch (e) {
                    console.log(e)
                }
                ...
                if (0 != $("#m_chart_bandwidth1").length) {
                    var e = document.getElementById("m_chart_bandwidth1").getContext("2d"), t = e.createLinearGradient(0, 0, 0, 240);
                ...
                if (0 != $("#m_chart_bandwidth2").length) {
                    var e = document.getElementById("m_chart_bandwidth2").getContext("2d"), t = e.createLinearGradient(0, 0, 0, 240);
                ...
                if (0 != $("#m_chart_adwords_stats").length) {
                    var e = document.getElementById("m_chart_adwords_stats").getContext("2d"), t = e.createLinearGradient(0, 0, 0, 240);
                    t.addColorStop(0, Chart.helpers.color("#ffefce").alpha(1).rgbString()), t.addColorStop(1, Chart.helpers.color("#ffefce").alpha(.3).rgbString());
                    var a = {
                        type: "line",
                        data: {
                ...
                if (0 != $("#m_chart_finance_summary").length) {
                    var e = document.getElementById("m_chart_finance_summary").getContext("2d"), t = {
                        type: "line",
                        data: {
                            labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                            datasets: [{
                ...
                if (0 != $("#m_dashboard_daterangepicker").length) {
                    var e = $("#m_dashboard_daterangepicker"), t = moment(), a = moment();
                    e.daterangepicker({
                ...
                data: {
                    type: "remote",
                    source: {read: {url: "http://localhost:8090/miaosha/order/getList"}},
                    pageSize: 10,
                ...
                columns: [{
                    ...
                    //template: "{{OrderID}} - {{ShipCountry}}"
                        ...
                        sortable: "asc", template: function (e) {
                            var t = {
                                /*
                                 4: {title: "Success", class: " m-badge--success"},
                                 5: {title: "Info", class: " m-badge--info"},
                                 7: {title: "Warning", class: " m-badge--warning"}
                                0: {title: "无", class: " m-badge--metal"},
                                3: {title: "已结束", class: " m-badge--primary"},*/
                                1: {title: "未开始", class: "m-badge--brand"},
                                2: {title: "秒杀", class: " m-badge--danger"},

                            };
                            if(e.status == 2){
                                return '<span style="margin-right: 8px;">'+e.title+'</span><span class="m-badge ' + t[e.status].class + ' m-badge--wide">' + t[e.status].title + "</span>" ;
                            }else{
                                return '<span>'+e.title+'</span>';
                            }

                    }},
                    { field: "itemPrice",title: "商品价格", width: 100}, {field: "amount", title: "商品数量", width: 100},
                    {field: "orderPrice", title: "订单价格", width: 100},{field: "orderTime", title: "下单时间", width: 100},
                     /*,{
